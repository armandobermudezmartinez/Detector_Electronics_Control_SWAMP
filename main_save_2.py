...
#print('status register', bin(sc_interface.device.getNode("Transactor-Slow-Control-0_config.SCA_Status0").read()))
#print('control register', bin(sc_interface.device.getNode("Transactor-Slow-Control-0_config.SCA_Control0").read()))
#print('number of successful transactions', bin(sc_interface.device.getNode("Transactor-Slow-Control-0_config.SCA_Status0.NbrTransactions").read()))
